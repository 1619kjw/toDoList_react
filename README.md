...
`import { faFacebook, faInstagram } from '@fortawesome/free-brands-svg-icons'` - 방법1 콤마치고 함께표기
`import * as brands from '@fortawesome/free-brands-svg-icons'` - 방법2 별칭지어 표기
### googleFonts 연결
1. 구글폰트 import 주소 복사
2. `index.html` 붙여넣기
...
* 빌드(Bulid)란? **소스코드 파일을 실행가능한 형태로 변환하는 과정**